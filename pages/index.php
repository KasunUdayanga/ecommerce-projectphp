    ...
    <header class="p-4 bg-green-500">
        ...
        <nav class="mt-2">
            <ul class="flex space-x-4">
                ...
                <li><a href="index.php" class="text-white hover:text-light-green-500">Products</a></li>
            ...
            <?php else: ?>
                <?php foreach ($products as $product): ?>
                    <div class="border border-gray-300 rounded-lg p-4">
                        ...
                        <a href="product.php?id=<?php echo $product['id']; ?>" class="inline-block mt-4 bg-green-500 text-white py-2 px-4 rounded hover:bg-light-green-500">View Product</a>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
