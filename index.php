            ...
            <?php else: ?>
                <?php foreach ($featuredProducts as $product): ?>
                    <div class="border border-gray-200 bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition">
                        ...
                        <p class="mt-4 text-lg font-semibold text-green-600">LKR<?php echo number_format($product['price'], 2); ?></p>
                        <?php if ($showSamples): ?>
                        ...
                        <?php else: ?>
                            <div class="mt-4 flex flex-wrap gap-2">
                                <a href="pages/product.php?id=<?php echo $product['id']; ?>" class="bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-100">View Product</a>
