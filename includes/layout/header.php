...
<header class="bg-green-500 text-white py-4">
    ...
    <?php if ($showHero): ?>
        <div class="container mx-auto px-4 pb-8 pt-10">
            <div class="rounded-2xl bg-white/20 p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="flex-1">
                    <h2 class="text-2xl md:text-3xl font-bold text-green-50"><?php echo htmlspecialchars($heroTitle); ?></h2>
                    <p class="mt-2 text-green-50 max-w-xl"><?php echo htmlspecialchars($heroSubtitle); ?></p>
